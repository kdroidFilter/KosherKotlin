...
public class Zman {
	...
	/**
	 * The duration if the <em>zman</em> is  a {@link com.kosherjava.zmanim.java.zmanim.AstronomicalCalendar#getTemporalHour() temporal hour} (or the various
	 * <em>shaah zmanis</em> base times such as {@link com.kosherjava.zmanim.java.zmanim.ZmanimCalendar#getShaahZmanisGra()  <em>shaah Zmanis GRA</em>} or
	 * {@link com.kosherjava.zmanim.java.zmanim.ComplexZmanimCalendar#getShaahZmanis16Point1Degrees() <em>shaah Zmanis 16.1&deg;</em>}).
	 */
	 ...
	 * {@link com.kosherjava.zmanim.java.zmanim.AstronomicalCalendar#getTemporalHour() temporal hour} (or the various <em>shaah zmanis</em> times such as
	 * {@link com.kosherjava.zmanim.java.zmanim.ZmanimCalendar#getShaahZmanisGra() <em>shaah zmanis GRA</em>} or
	 * {@link com.kosherjava.zmanim.java.zmanim.ComplexZmanimCalendar#getShaahZmanis16Point1Degrees() <em>shaah Zmanis 16.1&deg;</em>}) and label.
	 * @param duration a duration based <em>zman</em> such as ({@link com.kosherjava.zmanim.java.zmanim.AstronomicalCalendar#getTemporalHour()}
	...
	/**
	 * Returns a duration based <em>zman</em> such as {@link com.kosherjava.zmanim.java.zmanim.AstronomicalCalendar#getTemporalHour() temporal hour}
	 * (or the various <em>shaah zmanis</em> times such as {@link com.kosherjava.zmanim.java.zmanim.ZmanimCalendar#getShaahZmanisGra() <em>shaah zmanis GRA</em>}
	 * or {@link com.kosherjava.zmanim.java.zmanim.ComplexZmanimCalendar#getShaahZmanis16Point1Degrees() <em>shaah zmanis 16.1&deg;</em>}).
	...
	/**
	 *  Sets a duration based <em>zman</em> such as {@link com.kosherjava.zmanim.java.zmanim.AstronomicalCalendar#getTemporalHour() temporal hour}
	 * (or the various <em>shaah zmanis</em> times as {@link com.kosherjava.zmanim.java.zmanim.ZmanimCalendar#getShaahZmanisGra() <em>shaah zmanis GRA</em>} or
	 * {@link com.kosherjava.zmanim.java.zmanim.ComplexZmanimCalendar#getShaahZmanis16Point1Degrees() <em>shaah zmanis 16.1&deg;</em>}).
	 * @param duration duration based <em>zman</em> such as {@link com.kosherjava.zmanim.java.zmanim.AstronomicalCalendar#getTemporalHour()}.
	 * @see #getDuration()
	 */
	 ...
	 * {@link com.kosherjava.zmanim.java.zmanim.AstronomicalCalendar#getTemporalHour() temporal hour} (or the various <em>shaah zmanis</em> times
	 * such as <em>{@link com.kosherjava.zmanim.java.zmanim.ZmanimCalendar#getShaahZmanisGra() shaah zmanis GRA}</em> or
	 * {@link com.kosherjava.zmanim.java.zmanim.ComplexZmanimCalendar#getShaahZmanis16Point1Degrees() <em>shaah zmanis 16.1&deg;</em>}). Returns a negative
