...
/**
 * A class used to format both non {@link Date} times generated by the Zmanim package as well as Dates. For
...
public class ZmanimFormatter {
	 ...
	 *            the date to format
	 * @param calendar
	 *            the {@link Calendar Calendar} used to help format based on the Calendar's DST and other
	 *            settings.
	 ...
	 * 
	 * <pre>
	 *  &lt;AstronomicalTimes date=&quot;1969-02-08&quot; type=&quot;com.kosherjava.zmanim.java.zmanim.AstronomicalCalendar algorithm=&quot;US Naval Almanac Algorithm&quot; location=&quot;Lakewood, NJ&quot; latitude=&quot;40.095965&quot; longitude=&quot;-74.22213&quot; elevation=&quot;31.0&quot; timeZoneName=&quot;Eastern Standard Time&quot; timeZoneID=&quot;America/New_York&quot; timeZoneOffset=&quot;-5&quot;&gt;
	...
	public static String toXML(AstronomicalCalendar astronomicalCalendar) {
		...
		StringBuilder sb = new StringBuilder("<");
		if (astronomicalCalendar.getClass().getName().equals("com.kosherjava.zmanim.java.zmanim.AstronomicalCalendar")) {
		...
		} else if (astronomicalCalendar.getClass().getName().equals("com.kosherjava.zmanim.java.zmanim.ComplexZmanimCalendar")) {
			sb.append("Zmanim");
			// TODO: use proper schema ref, and maybe build a real schema.
			// output += "xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" ";
			// output += xsi:schemaLocation="http://www.kosherjava.com/zmanim zmanim.xsd"
		} else if (astronomicalCalendar.getClass().getName().equals("com.kosherjava.zmanim.java.zmanim.ZmanimCalendar")) {
	 ...
	 *    &quot;metadata&quot;:{
	 *      &quot;date&quot;:&quot;1969-02-08&quot;,
	 *      &quot;type&quot;:&quot;com.kosherjava.zmanim.java.zmanim.AstronomicalCalendar&quot;,
