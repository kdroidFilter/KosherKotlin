 ...
 * <code>{@link Date}</code> is expected and {@link Long#MIN_VALUE} when a <code>long</code> is expected. The
...
public class AstronomicalCalendar implements Cloneable {
	 ...
	 *            parameter.
	 * @return The {@link Date} of the offset after (or before) {@link #getSunrise()}. If the calculation
	 ...
	 * @return The {@link Date}of the offset after (or before) {@link #getSunset()}. If the calculation can't
