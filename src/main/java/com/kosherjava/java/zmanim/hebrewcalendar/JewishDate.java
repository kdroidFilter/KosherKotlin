...
//		System.out.println("Molad date java: " + moladDate);
	...
	/**
	 * A constructor that initializes the date to the {@link LocalDate LocalDate} paremeter.
	 *
	 * @param localDate
	...
	/**
	 * Sets the date based on a {@link LocalDate LocalDate} object. Modifies the Jewish date as well.
	 *
	 * @param localDate
	 *            the <code>LocalDate</code> to set the calendar to
	 * @throws IllegalArgumentException
