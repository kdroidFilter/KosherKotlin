...
public class ZmanimCalendar extends AstronomicalCalendar {
	 ...
	 * {@link AstronomicalCalculator calculator} class used supports it and
	 ...
	 * two {@link AstronomicalCalculator calculators} available in the API, the default {@link
	 ...
	 * AstronomicalCalculator calculators} available in the API, the {@link
