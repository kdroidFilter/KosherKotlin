...
public class YomiCalculator {
	 ...
	 * @see #getDafYomiBavli(com.kosherjava.zmanim.hebrewcalendar.JewishCalendar) for details.
	 */
	 ...
	 * href="http://en.wikipedia.org/wiki/Talmud">Bavli</a> {@link com.kosherjava.zmanim.hebrewcalendar.Daf} for a given date. The first Daf Yomi cycle
	 ...
	 * @return the {@link com.kosherjava.zmanim.hebrewcalendar.Daf}.
	 * 
	 * @throws IllegalArgumentException
	 *             if the date is prior to the September 11, 1923 start date of the first Daf Yomi cycle
	 */
	public static com.kosherjava.zmanim.hebrewcalendar.Daf getDafYomiBavli(JewishCalendar jewishCalendar) {
		/*
