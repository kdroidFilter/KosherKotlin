 ...
 * "https://en.wikipedia.org/wiki/Daf_Yomi">Daf Yomi</a> page ({@link com.kosherjava.zmanim.hebrewcalendar.Daf}) for the a given date.
 * 
...
public class YerushalmiYomiCalculator {
	 ...
	 * <a href="https://en.wikipedia.org/wiki/Jerusalem_Talmud">Yerusalmi</a> page ({@link com.kosherjava.zmanim.hebrewcalendar.Daf}) for a given date.
	 ...
	 * @return the {@link com.kosherjava.zmanim.hebrewcalendar.Daf} or null if the date is on Tisha B'Av or Yom Kippur.
	 *
	 * @throws IllegalArgumentException
	 *             if the date is prior to the February 2, 1980, the start of the first Daf Yomi Yerushalmi cycle
	 */
	public static com.kosherjava.zmanim.hebrewcalendar.Daf getDafYomiYerushalmi(com.kosherjava.zmanim.hebrewcalendar.JewishCalendar calendar) {
		...
		int masechta = 0;
		com.kosherjava.zmanim.hebrewcalendar.Daf dafYomi = null;

		// There isn't Daf Yomi on Yom Kippur or Tisha B'Av.
		if ( calendar.getYomTovIndex() == com.kosherjava.zmanim.hebrewcalendar.JewishCalendar.YOM_KIPPUR ||
				calendar.getYomTovIndex() == com.kosherjava.zmanim.hebrewcalendar.JewishCalendar.TISHA_BEAV ) {
			return null;
		}
	...
	private static int getNumOfSpecialDays(Calendar start, Calendar end) {
		...
		int startYear = new com.kosherjava.zmanim.hebrewcalendar.JewishCalendar(start).getJewishYear();
		int endYear = new com.kosherjava.zmanim.hebrewcalendar.JewishCalendar(end).getJewishYear();
		
		// Value to return
		int specialDays = 0;
		
		//Instant of special Dates
		com.kosherjava.zmanim.hebrewcalendar.JewishCalendar yom_kippur = new com.kosherjava.zmanim.hebrewcalendar.JewishCalendar(5770, 7, 10);
		com.kosherjava.zmanim.hebrewcalendar.JewishCalendar tisha_beav = new JewishCalendar(5770, 5, 9);
