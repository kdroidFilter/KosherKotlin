 ...
 * (Medzhybizh) celebrated on 11 {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#TEVES <em>Teves</em>} or <a href=
 * "https://en.wikipedia.org/wiki/Second_Purim#Purim_Saragossa_(18_Shevat)">Purim Saragossa</a> celebrated on
 * the (17th or) 18th of {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#SHEVAT <em>Shevat</em>} are not (and likely will not be) supported by
 * this class.
 * <p>Sample code:
...
public class TefilaRules {
	...
	public boolean isTachanunRecitedShacharis(JewishCalendar jewishCalendar) {
		...
		if (jewishCalendar.getDayOfWeek() == Calendar.SATURDAY
				...
				|| month == com.kosherjava.zmanim.hebrewcalendar.JewishDate.NISSAN
				|| (month == com.kosherjava.zmanim.hebrewcalendar.JewishDate.TISHREI && ((!tachanunRecitedEndOfTishrei && day > 8)
				|| (tachanunRecitedEndOfTishrei && (day > 8 && day < 22))))
				|| (month == com.kosherjava.zmanim.hebrewcalendar.JewishDate.SIVAN && (tachanunRecitedWeekAfterShavuos && day < 7
				...
				|| (!jewishCalendar.getInIsrael() && !tachanunRecitedPesachSheni && !tachanunRecited15IyarOutOfIsrael
						&& jewishCalendar.getJewishMonth() == com.kosherjava.zmanim.hebrewcalendar.JewishDate.IYAR && day == 15)
				...
				|| (!tachanunRecitedShivasYemeiHamiluim &&
						((!jewishCalendar.isJewishLeapYear() && month == com.kosherjava.zmanim.hebrewcalendar.JewishDate.ADAR)
								|| (jewishCalendar.isJewishLeapYear() && month == com.kosherjava.zmanim.hebrewcalendar.JewishDate.ADAR_II)) && day > 22)
				|| (!tachanunRecitedWeekOfPurim &&
						((!jewishCalendar.isJewishLeapYear() && month == com.kosherjava.zmanim.hebrewcalendar.JewishDate.ADAR)
								|| (jewishCalendar.isJewishLeapYear() && month == com.kosherjava.zmanim.hebrewcalendar.JewishDate.ADAR_II)) && day > 10 && day < 18)
				|| (jewishCalendar.isUseModernHolidays()
						&& (holidayIndex == JewishCalendar.YOM_HAATZMAUT || holidayIndex == JewishCalendar.YOM_YERUSHALAYIM))
				|| (!tachanunRecitedWeekOfHod && month == com.kosherjava.zmanim.hebrewcalendar.JewishDate.IYAR && day > 13 && day < 21)) {
			return false;
		}
		return true;
	}
	 ...
	 * (<em>Sheailas Geshamim</em>). In Israel this is the 7th day of {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#CHESHVAN <em>Marcheshvan</em>}.
	...
	public boolean isVeseinTalUmatarStartDate(JewishCalendar jewishCalendar) {
		if (jewishCalendar.getInIsrael()) {
			...
			if (jewishCalendar.getJewishMonth() == com.kosherjava.zmanim.hebrewcalendar.JewishDate.CHESHVAN && jewishCalendar.getJewishDayOfMonth() == 7) {
				return true;
			}
		} else {
	 ...
	 * <em>Sheailas Geshamim</em>). In Israel this is the 7th day of {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#CHESHVAN
	...
	public boolean isVeseinTalUmatarStartingTonight(JewishCalendar jewishCalendar) {
		if (jewishCalendar.getInIsrael()) {
			...
			if (jewishCalendar.getJewishMonth() == com.kosherjava.zmanim.hebrewcalendar.JewishDate.CHESHVAN && jewishCalendar.getJewishDayOfMonth() == 6) {
					return true;
			}
		} else {
	...
	public boolean isVeseinTalUmatarRecited(JewishCalendar jewishCalendar) {
		if (jewishCalendar.getJewishMonth() == com.kosherjava.zmanim.hebrewcalendar.JewishDate.NISSAN && jewishCalendar.getJewishDayOfMonth() < 15) {
			return true;
		}
		if (jewishCalendar.getJewishMonth() < com.kosherjava.zmanim.hebrewcalendar.JewishDate.CHESHVAN) {
			return false;
		}
		if (jewishCalendar.getInIsrael()) {
			return jewishCalendar.getJewishMonth() != com.kosherjava.zmanim.hebrewcalendar.JewishDate.CHESHVAN || jewishCalendar.getJewishDayOfMonth() >= 7;
		} else {
			return jewishCalendar.getTekufasTishreiElapsedDays() >= 47;
		}
	}
	...
	/**
	 * Returns if <em>Vesein Beracha</em> is recited. It is recited from 15 {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#NISSAN <em>Nissan</em>} to the
	 ...
	 * {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#TISHREI <em>Tishrei</em>}.
	 * 
	 * @param jewishCalendar the Jewish calendar day.
	...
	public boolean isMashivHaruachStartDate(JewishCalendar jewishCalendar) {
		return jewishCalendar.getJewishMonth() == com.kosherjava.zmanim.hebrewcalendar.JewishDate.TISHREI && jewishCalendar.getJewishDayOfMonth() == 22;
	}

	/**
	 * Returns if the date is the end date for reciting <em>Mashiv Haruach Umorid Hageshem</em>. The date is 15
	 * {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#NISSAN <em>Nissan</em>}.
	 * 
	 * @param jewishCalendar the Jewish calendar day.
	...
	public boolean isMashivHaruachEndDate(JewishCalendar jewishCalendar) {
		return jewishCalendar.getJewishMonth() == com.kosherjava.zmanim.hebrewcalendar.JewishDate.NISSAN && jewishCalendar.getJewishDayOfMonth() == 15;
	}

	/**
	 * Returns if <em>Mashiv Haruach Umorid Hageshem</em> is recited. This period starts on 22 {@link
	 * com.kosherjava.zmanim.hebrewcalendar.JewishDate#TISHREI <em>Tishrei</em>} and ends on the 15th day of {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#NISSAN <em>Nissan</em>}.
	 * 
	 * @param jewishCalendar the Jewish calendar day.
	...
	public boolean isMashivHaruachRecited(JewishCalendar jewishCalendar) {
		com.kosherjava.zmanim.hebrewcalendar.JewishDate startDate = new com.kosherjava.zmanim.hebrewcalendar.JewishDate(jewishCalendar.getJewishYear(), com.kosherjava.zmanim.hebrewcalendar.JewishDate.TISHREI, 22);
		com.kosherjava.zmanim.hebrewcalendar.JewishDate endDate = new com.kosherjava.zmanim.hebrewcalendar.JewishDate(jewishCalendar.getJewishYear(), com.kosherjava.zmanim.hebrewcalendar.JewishDate.NISSAN, 15);
	 ...
	 * recited. This period starts on the 15th day of {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#NISSAN <em>Nissan</em>} and ends on 22 {@link
	 * com.kosherjava.zmanim.hebrewcalendar.JewishDate#TISHREI <em>Tishrei</em>}.
	 * 
	 * @param jewishCalendar the Jewish calendar day.
	 * 
	...
	public boolean isHallelRecited(JewishCalendar jewishCalendar) {
		...
		switch (month) {
			case com.kosherjava.zmanim.hebrewcalendar.JewishDate.NISSAN:
				if(day >= 15 && ((inIsrael && day <= 21) || (!inIsrael && day <= 22))){
					return true;
				}
				break;
			case com.kosherjava.zmanim.hebrewcalendar.JewishDate.IYAR: // modern holidays
				...
				break;
			case com.kosherjava.zmanim.hebrewcalendar.JewishDate.SIVAN:
				if (day == 6 || (!inIsrael && (day == 7))){
					return true;
				}
				break;
			case com.kosherjava.zmanim.hebrewcalendar.JewishDate.TISHREI:
	...
	public boolean isHallelShalemRecited(JewishCalendar jewishCalendar) {
		...
		if(isHallelRecited(jewishCalendar)) {
			if((jewishCalendar.isRoshChodesh() && ! jewishCalendar.isChanukah())
					|| (month == com.kosherjava.zmanim.hebrewcalendar.JewishDate.NISSAN && ((inIsrael && day > 15) || (!inIsrael && day > 16)))) {
				return false;
			} else {
				return true;
			}
	 ...
	 * com.kosherjava.zmanim.hebrewcalendar.JewishDate#ADAR <em>Adar</em>} (on a non-leap year, or {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#ADAR_II <em>Adar II</em>} on a leap year). Some
	 ...
	 *         com.kosherjava.zmanim.hebrewcalendar.JewishDate#ADAR <em>Adar</em>} (on a non-leap year, or {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#ADAR_II <em>Adar II</em>} on a leap year).
	 * @see #setTachanunRecitedWeekOfPurim(boolean)
	 */
	 ...
	 *         through the 17th of {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#ADAR <em>Adar</em>} (on a non-leap year), or {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#ADAR_II
	 ...
	 * com.kosherjava.zmanim.hebrewcalendar.JewishDate#IYAR <em>Iyar</em>}, or the 29th - 35th of the {@link JewishCalendar#getDayOfOmer() <em>Omer</em>}). Some
	 ...
	 *         com.kosherjava.zmanim.hebrewcalendar.JewishDate#IYAR <em>Iyar</em>}, or the 29th - 35th of the {@link JewishCalendar#getDayOfOmer() <em>Omer</em>}).
	 * @see #setTachanunRecitedWeekOfHod(boolean)
	 */
	 ...
	 * {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#IYAR <em>Iyar</em>}, or the 29th - 35th of the {@link JewishCalendar#getDayOfOmer() <em>Omer</em>}).
	...
	/**
	 * Is <em>tachanun</em> set to be recited at the end Of {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#TISHREI <em>Tishrei</em>}.The Magen Avraham 669:1 and
	 ...
	 * @return If <em>tachanun</em> is set to be recited at the end of {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#TISHREI <em>Tishrei</em>}.
	...
	/**
	 * Sets if <em>tachanun</em> should be recited at the end of {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#TISHREI <em>Tishrei</em>}.
	 * @param tachanunRecitedEndOfTishrei is <em>tachanun</em> recited at the end of {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#TISHREI <em>Tishrei</em>}.
	 * @see #isTachanunRecitedEndOfTishrei()
	 */
	...
	/**
	 * Is <em>tachanun</em> is set to be recited on the 13th of {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#SIVAN <em>Sivan</em>} (<a href=
	 ...
	 * 
	 * @return If <em>tachanun</em> is set to be recited on the 13th of {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#SIVAN <em>Sivan</em>} out of Israel.
	...
	/**
	 * Sets if <em>tachanun</em> should be recited on the 13th of {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#SIVAN <em>Sivan</em>} (<a href=
	 * "https://en.wikipedia.org/wiki/Yom_tov_sheni_shel_galuyot"><em>Yom Tov Sheni shel Galuyos</em></a> of the 7th
	 * day) outside Israel. 
	 * @param tachanunRecitedThirteenSivanOutOfIsrael sets if <em>tachanun</em> should be recited on the 13th of {@link
	 *          com.kosherjava.zmanim.hebrewcalendar.JewishDate#SIVAN <em>Sivan</em>} out of Israel. Both {@link #isTachanunRecitedShacharis(JewishCalendar)} and
	...
	/**
	 * Is <em>tachanun</em> set to be recited on 15 {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#IYAR <em>Iyar</em>} (<em>sfaika deyoma</em> of {@link
	 ...
	 * 
	 * @return if <em>tachanun</em> is set to be recited on 15 {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#IYAR <em>Iyar</em>}  (<em>sfaika deyoma</em>
	...
	/**
	 * Sets if <em>tachanun</em> should be recited on the 15th of {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#IYAR <em>Iyar</em>}  (<a href=
	 ...
	 * 
	 * @param tachanunRecited15IyarOutOfIsrael if <em>tachanun</em> should be recited on the 15th of {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#IYAR
	 ...
	 * com.kosherjava.zmanim.hebrewcalendar.JewishDate#ADAR <em>Adar</em>} on a non-leap-year or {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#ADAR_II <em>Adar II</em>} on a
	 ...
	 *           of {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#ADAR <em>Adar</em>} on a non-leap-year or {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#ADAR_II
	 ...
	 * {@link com.kosherjava.zmanim.hebrewcalendar.JewishDate#ADAR <em>Adar</em>} on a non-leap-year or {@link JewishDate#ADAR_II <em>Adar II</em>}
