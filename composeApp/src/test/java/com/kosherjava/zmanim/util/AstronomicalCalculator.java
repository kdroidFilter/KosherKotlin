...
public abstract class AstronomicalCalculator implements Cloneable {
	...
	/**
	 * Returns the default class for calculating sunrise and sunset. This is currently the {@link com.kosherjava.zmanim.util.NOAACalculator},
	 * but this may change.
	 * 
	 * @return AstronomicalCalculator the default class for calculating sunrise and sunset. In the current
	 *         implementation the default calculator returned is the {@link com.kosherjava.zmanim.util.NOAACalculator}.
	 */
	 ...
	 */
	public abstract double getUTCSunrise(Calendar calendar, com.kosherjava.zmanim.util.GeoLocation geoLocation, double zenith,
	 ...
	 * @see #getElevationAdjustment(double)
	 */
	public abstract double getUTCSunset(Calendar calendar, com.kosherjava.zmanim.util.GeoLocation geoLocation, double zenith,
                                        boolean adjustForElevation);
