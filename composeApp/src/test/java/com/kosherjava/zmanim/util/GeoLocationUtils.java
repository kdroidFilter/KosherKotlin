 ...
 * @deprecated All methods in this call are available in the {@link com.kosherjava.zmanim.util.GeoLocation} class, and this class that duplicates that
 * code will be removed in release 3.0.
 */
public class GeoLocationUtils {
	/**
	 * Constant for a distance type calculation.
	 * @see #getGeodesicDistance(com.kosherjava.zmanim.util.GeoLocation, com.kosherjava.zmanim.util.GeoLocation)
	 */
	private static int DISTANCE = 0;
	
	/**
	 * Constant for a initial bearing type calculation.
	 * @see #getGeodesicInitialBearing(com.kosherjava.zmanim.util.GeoLocation, com.kosherjava.zmanim.util.GeoLocation)
	 */
	private static int INITIAL_BEARING = 1;
	
	/**
	 * Constant for a final bearing type calculation.
	 * @see #getGeodesicFinalBearing(com.kosherjava.zmanim.util.GeoLocation, com.kosherjava.zmanim.util.GeoLocation)
	 */
	 ...
	 */
	public static double getGeodesicInitialBearing(com.kosherjava.zmanim.util.GeoLocation location, com.kosherjava.zmanim.util.GeoLocation destination) {
	 ...
	 * @return the geodesic bearing
	 */
	public static double getGeodesicFinalBearing(com.kosherjava.zmanim.util.GeoLocation location, com.kosherjava.zmanim.util.GeoLocation destination) {
	 ...
	 */
	public static double getGeodesicDistance(com.kosherjava.zmanim.util.GeoLocation location, com.kosherjava.zmanim.util.GeoLocation destination) {
	 ...
	 * @see #getGeodesicFinalBearing(com.kosherjava.zmanim.util.GeoLocation, com.kosherjava.zmanim.util.GeoLocation)
	 */
	private static double vincentyFormula(com.kosherjava.zmanim.util.GeoLocation location, com.kosherjava.zmanim.util.GeoLocation destination, int formula) {
	 ...
	 */
	public static double getRhumbLineBearing(com.kosherjava.zmanim.util.GeoLocation location, com.kosherjava.zmanim.util.GeoLocation destination) {
	 ...
	 */
	public static double getRhumbLineDistance(com.kosherjava.zmanim.util.GeoLocation location, GeoLocation destination) {
