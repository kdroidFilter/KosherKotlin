 ...
 * account for leap years. It is not as accurate as the Jean Meeus based {@link com.kosherjava.zmanim.util.NOAACalculator} that is the default calculator
...
public class SunTimesCalculator extends AstronomicalCalculator {
	...
	/**
	 * @see AstronomicalCalculator#getUTCSunrise(Calendar, com.kosherjava.zmanim.util.GeoLocation, double, boolean)
	 */
	public double getUTCSunrise(Calendar calendar, com.kosherjava.zmanim.util.GeoLocation geoLocation, double zenith, boolean adjustForElevation) {
	...
	/**
	 * @see AstronomicalCalculator#getUTCSunset(Calendar, com.kosherjava.zmanim.util.GeoLocation, double, boolean)
	 */
	public double getUTCSunset(Calendar calendar, com.kosherjava.zmanim.util.GeoLocation geoLocation, double zenith, boolean adjustForElevation) {
		double doubleTime = Double.NaN;
		double elevation = adjustForElevation ? geoLocation.getElevation() : 0;
		double adjustedZenith = adjustZenith(zenith, elevation);
	 ...
	 */
	private static double getTimeUTC(Calendar calendar, com.kosherjava.zmanim.util.GeoLocation geoLocation, double zenith, boolean isSunrise) {
	 ...
	 * {@link com.kosherjava.zmanim.util.NOAACalculator}, the default calculator, returns true solar noon. See <a href=
	 * "https://kosherjava.com/2020/07/02/definition-of-chatzos/">The Definition of Chatzos</a> for details on solar
	 * noon calculations.
	 * @see AstronomicalCalculator#getUTCNoon(Calendar, com.kosherjava.zmanim.util.GeoLocation)
	 * @see NOAACalculator
	 * 
	 * @param calendar
