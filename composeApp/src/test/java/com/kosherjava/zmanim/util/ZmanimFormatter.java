...
public class ZmanimFormatter {
	...
	/**
	 * constructor that defaults to this will use the format "h:mm:ss" for dates and 00.00.00.0 for {@link com.kosherjava.zmanim.util.Time}.
	...
	public String format(int millis) {
		return format(new com.kosherjava.zmanim.util.Time(millis));
	}

	/**
	 * A method that formats {@link com.kosherjava.zmanim.util.Time}objects.
	 * 
	 * @param time
	 *            The time <code>Object</code> to be formatted.
	 * @return String The formatted <code>String</code>
	 */
	public String format(com.kosherjava.zmanim.util.Time time) {
	...
	public String formatXSDDurationTime(long millis) {
		return formatXSDDurationTime(new com.kosherjava.zmanim.util.Time(millis));
	}
