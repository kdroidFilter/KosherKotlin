...
object TestHelper {
   ...
   // val arcticNunavut = GeoLocation("Fort Conger, NU Canada", 81.7449398, -64.7945858, 127.0, TimeZone.of("America/Toronto")) //TODO
    val basicLocations = listOf(lakewood, jerusalem, losAngeles, tokyo, samoa)
