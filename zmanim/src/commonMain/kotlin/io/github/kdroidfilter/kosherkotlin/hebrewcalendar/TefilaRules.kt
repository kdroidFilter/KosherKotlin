 ...
 * Maharich Vol 2 Seder Hanhagos Erev Shabbos](https://hebrewbooks.org/pdfpager.aspx?req=41190&st=&pgnum=10).
    ...
    fun isTachanunRecitedShacharis(jewishCalendar: JewishCalendar): Boolean {
        ...
        return !(
                jewishCalendar.gregorianLocalDate.dayOfWeek == DayOfWeek.SATURDAY ||
                        ...
                        month == io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.NISSAN ||
                        month == io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.TISHREI &&
                        (
                                !isTachanunRecitedEndOfTishrei && day > 8 ||
                                        isTachanunRecitedEndOfTishrei && day in 9..21/*8 < day < 22*/
                                ) ||
                        month == io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.SIVAN && (
                        ...
                        month == io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.IYAR && day == 15 ||
                        ...
                        !jewishCalendar.isJewishLeapYear && month == io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.ADAR ||
                                jewishCalendar.isJewishLeapYear && month == io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.ADAR_II
                        ) && day > 22 ||
    ...
    fun isVeseinTalUmatarStartDate(jewishCalendar: JewishCalendar): Boolean =
        if (jewishCalendar.inIsrael) jewishCalendar.hebrewLocalDate.month == io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.CHESHVAN && jewishCalendar.jewishDayOfMonth == 7 // The 7th Cheshvan can't occur on Shabbos, so always return true for 7 Cheshvan
    ...
    fun isVeseinTalUmatarStartingTonight(jewishCalendar: JewishCalendar): Boolean =
        if (jewishCalendar.inIsrael)
            jewishCalendar.hebrewLocalDate.month == io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.CHESHVAN && jewishCalendar.jewishDayOfMonth == 6 // The 7th Cheshvan can't occur on Shabbos, so always return true for 6 Cheshvan
        else {
    ...
    fun isVeseinTalUmatarRecited(jewishCalendar: JewishCalendar): Boolean = when {
        jewishCalendar.hebrewLocalDate.month == io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.NISSAN && jewishCalendar.jewishDayOfMonth < 15 -> true
        jewishCalendar.hebrewLocalDate.month < io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.CHESHVAN -> false
        jewishCalendar.inIsrael -> jewishCalendar.hebrewLocalDate.month != io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.CHESHVAN || jewishCalendar.jewishDayOfMonth >= 7
        else -> jewishCalendar.tekufasTishreiElapsedDays >= 47
    }
    ...
    fun isMashivHaruachStartDate(jewishCalendar: JewishCalendar): Boolean =
        jewishCalendar.hebrewLocalDate.month == io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.TISHREI && jewishCalendar.jewishDayOfMonth == 22
    ...
    fun isMashivHaruachEndDate(jewishCalendar: JewishCalendar): Boolean =
        jewishCalendar.hebrewLocalDate.month == io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.NISSAN && jewishCalendar.jewishDayOfMonth == 15
    ...
    fun isHallelRecited(jewishCalendar: JewishCalendar): Boolean {
        ...
        return jewishCalendar.isRoshChodesh || //RH returns false for RC
            jewishCalendar.isChanukah ||
                month == io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.NISSAN && day >= 15 && (inIsrael && day <= 21 || !inIsrael && day <= 22) ||
        ...
        return isHallelRecited(jewishCalendar) &&
                !(
                        jewishCalendar.isRoshChodesh && !jewishCalendar.isChanukah ||
                                month == io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.NISSAN && day > if(inIsrael) 15 else 16
                        )
    }
