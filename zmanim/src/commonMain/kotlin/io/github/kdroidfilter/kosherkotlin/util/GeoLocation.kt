...
import io.github.kdroidfilter.kosherkotlin.util.AstronomicalCalculator.Companion.toDegrees
import io.github.kdroidfilter.kosherkotlin.util.AstronomicalCalculator.Companion.toRadians
 ...
 * Meridian](https://en.wikipedia.org/wiki/Prime_Meridian) (Greenwich), a negative value should be used.
    ...
    companion object {
        val mapOfTimeZoneIdToRawOffsetInMillis: Map<String, Int> by lazy { mapOf(
            ...
            "America/Ciudad_Juarez" to -25200000,
            "America/Chihuahua" to -21600000,
            "America/Coral_Harbour" to -18000000,
            "America/Cordoba" to -10800000,
            "America/Costa_Rica" to -21600000,
            "America/Coyhaique" to -10800000,
            ...
            "America/Scoresbysund" to -7200000,
            ...
            "Antarctica/Vostok" to 18000000,
            "Arctic/Longyearbyen" to 3600000,
            "Asia/Aden" to 10800000,
            "Asia/Almaty" to 18000000,
            "Asia/Amman" to 10800000,
