...
import io.github.kdroidfilter.kosherkotlin.util.AstronomicalCalculator
...
open class AstronomicalCalendar(
    ...
    val beginNauticalTwilight: Instant?
        get() = getSunriseOffsetByDegrees(io.github.kdroidfilter.kosherkotlin.AstronomicalCalendar.Companion.NAUTICAL_ZENITH)
    ...
    val beginAstronomicalTwilight: Instant?
        get() = getSunriseOffsetByDegrees(io.github.kdroidfilter.kosherkotlin.AstronomicalCalendar.Companion.ASTRONOMICAL_ZENITH)
    ...
    val endNauticalTwilight: Instant?
        get() = getSunsetOffsetByDegrees(io.github.kdroidfilter.kosherkotlin.AstronomicalCalendar.Companion.NAUTICAL_ZENITH)
    ...
    val endAstronomicalTwilight: Instant?
        get() = getSunsetOffsetByDegrees(io.github.kdroidfilter.kosherkotlin.AstronomicalCalendar.Companion.ASTRONOMICAL_ZENITH)
    ...
    fun getSunTransit(startOfDay: Instant?, endOfDay: Instant?): Instant? =
        io.github.kdroidfilter.kosherkotlin.AstronomicalCalendar.Companion.getTimeOffset(
            startOfDay,
            getTemporalHour(startOfDay, endOfDay) * 6
        )
...
//        val dt = cal.toLocalDateTime(timeZone)
    ...
    fun getSunriseSolarDipFromOffset(minutes: Double): Double {
        ...
        val offsetByTime: Instant? = io.github.kdroidfilter.kosherkotlin.AstronomicalCalendar.Companion.getTimeOffset(
            seaLevelSunrise,
            -(minutes * io.github.kdroidfilter.kosherkotlin.AstronomicalCalendar.Companion.MINUTE_MILLIS)
        )
        var degrees = 0.0
    ...
    fun getSunsetSolarDipFromOffset(minutes: Double): Double {
        ...
        val offsetByTime: Instant? = io.github.kdroidfilter.kosherkotlin.AstronomicalCalendar.Companion.getTimeOffset(
            seaLevelSunset, minutes * io.github.kdroidfilter.kosherkotlin.AstronomicalCalendar.Companion.MINUTE_MILLIS
        )
        var degrees = 0.0
...
//    fun toJSON(): String = ZmanimFormatter.toJSON(this)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is io.github.kdroidfilter.kosherkotlin.AstronomicalCalendar) return false
     ...
     * @see Object.clone
     */
    fun copy(): io.github.kdroidfilter.kosherkotlin.AstronomicalCalendar = io.github.kdroidfilter.kosherkotlin.AstronomicalCalendar(
        geoLocation.copy()
    ).apply { //TODO copy over date once superclass constructors are figured out
    ...
    companion object {
        ...
        const val HOUR_MILLIS: Long = io.github.kdroidfilter.kosherkotlin.AstronomicalCalendar.Companion.MINUTE_MILLIS * 60
        ...
        fun getTimeOffset(time: Instant?, offset: Double): Instant? =
            io.github.kdroidfilter.kosherkotlin.AstronomicalCalendar.Companion.getTimeOffset(time, offset.toLong())
