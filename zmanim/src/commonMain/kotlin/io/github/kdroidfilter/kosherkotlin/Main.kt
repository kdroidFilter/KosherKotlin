...
val lakewood = GeoLocation("Lakewood, NJ", 40.0721087, -74.2400243, 15.0, TimeZone.of("America/New_York"))
    ...
    val arcticNunavut =
        GeoLocation("Fort Conger, NU Canada", 81.7449398, -64.7945858, 127.0, TimeZone.of("America/Iqaluit"))
...
//    println(days.milliseconds.inWholeNanoseconds)
    ...
    val year6000 = HebrewLocalDate(6000, io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.TISHREI, 1).toLocalDateGregorian()
