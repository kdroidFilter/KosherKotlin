...
import io.github.kdroidfilter.kosherkotlin.hebrewcalendar.JewishDate.Companion.isJewishLeapYear
import kotlin.math.absoluteValue

enum class HebrewMonth(val value: Int) : Comparable<io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth> {
    /**
     ...
     * */
    val previousMonth get() = io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.Companion.getMonthForValue(
        value - 1
    )
     ...
     * */
    val nextMonth get() = io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.Companion.getMonthForValue(
        value + 1
    )

    fun isLastMonthInYear(jewishYear: Long, tishreiBased: Boolean = true) =
        if(tishreiBased) this == io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.ELUL
        else
            if(jewishYear.isJewishLeapYear) this == io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.ADAR_II
            else this == io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.ADAR

    fun isFirstMonthInYear(tishreiBased: Boolean = true) =
        tishreiBased && this == io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.TISHREI || this == io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.NISSAN
    ...
    fun getNextMonthInYear(jewishYear: Long, tishreiBased: Boolean = true) =
        if (this.isLastMonthInYear(
            ...
            if (this == io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.ADAR)
                if(jewishYear.isJewishLeapYear) io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.ADAR_II
                else io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.NISSAN
            else nextMonth

    /**
     * Returns the number of days in this month for the given [jewishYear].
     * */
    fun getNumDaysInMonthForYear(jewishYear: Long) =
        io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewLocalDate.Companion.getNumDaysInHebrewMonth(
            this,
            jewishYear
        )

    fun getTishreiBasedValueInYear(jewishYear: Long) =
        io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.Companion.getTishreiBasedValue(value, jewishYear)
    fun toTishreiBasedMonthInYear(jewishYear: Int) =
        io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.Companion.getTishreiBasedMonth(this, jewishYear)
    ...
    class HebrewMonthRange(
        override val start: io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth,
        override val endInclusive: io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth
    ) : ClosedRange<io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth>, Iterable<io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth> {
        override fun iterator(): Iterator<io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth> = object : Iterator<io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth> {
            private var next = start
            private var hasNext = start <= endInclusive
            override fun hasNext(): Boolean = hasNext
            override fun next(): io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth {
                val value = next
    ...
    companion object {
         ...
         * */
        fun getMonthForValue(value: Int): io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth {
            val values = values()
        ...
        fun getTishreiBasedValue(nissanBasedValue: Int, jewishYear: Int): Int =
            io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.Companion.getTishreiBasedValue(
                nissanBasedValue,
                jewishYear.toLong()
            )
         ...
         * */
        fun getTishreiBasedMonth(month: io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth, jewishYear: Int) =
            io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.Companion.getTishreiBasedMonth(
                month,
                jewishYear.toLong()
            )
        fun getTishreiBasedMonth(month: io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth, jewishYear: Long) =
            io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.Companion.getMonthForValue(
                io.github.kdroidfilter.kosherkotlin.hebrewcalendar.HebrewMonth.Companion.getTishreiBasedValue(
                    month.value,
                    jewishYear
                )
